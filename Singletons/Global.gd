...
var poem_text_dict: Dictionary = { ## syntax: ID: ["text", "source", checked-out, found/read]
	...
	23: ["That the creature\ncan’t walk unshod\n“calls itself into\nquestion,” its inquiry\n(footsteplike) serenely alternating?", "[unpublished]", false, false],
	24: ["That dark wellwater\nyou splash into\nalone and float\nwhile around you\nfriends fall through?", "[unpublished]", false, false],
	25: ["That no untidy\nimagination candies candle\nflames to make\nthem halvable with\na sword swipe?", "[unpublished]", false, false], 
	27: ["That penning “purple\nstrides of warlike\nsunset” reflects purple\nvisionlessness accurately imparts\ncolorless vision partially?", "[unpublished]", false, false],
	28: ["That “is consciousness\nas vegetarian as\nartichokes” is their\nin-joke, published by\ntheir food’s calories?", "[unpublished]", false, false],
