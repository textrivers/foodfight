...
var poem_text_dict: Dictionary = {
	...
	10: "They found a way to share dreams between people,\nNot by lifting from one person / inserting in another\nBut by placing something playable on their shared border,", 
	11: "Metadata inscribing the reproducibility of the dream\nDoesn't match up with its own reinscription.\nThe game's goal, only, is to reconcile them.", 
